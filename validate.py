...
def validate_auxiliary_verbs(cols, children, nodes, line, lang):
    ...
    if cols[UPOS] == 'AUX' and cols[LEMMA] != '_':
        ...
        auxdict = {
            ...
            # I will wait with approving the following until they are at least documented: 'दीह', 'जात', 'कइला', 'होखा', 'बानी', 'लाँ', 'दिहलसि'
            'bho': ['हऽ', 'आ', 'सन', 'बा', 'भा', 'ना', 'गइल', 'रह', 'कर', 'जा', 'सक', 'पा', 'चाही', 'हो', 'पड़', 'लग', 'चुक', 'ले', 'दे', 'डाल', 'बैठ', 'उठ', 'रख'],
