...
# 		if cols[col_idx] != '_' or (col_idx == utils.FEATS and cols[col_idx] != 'Typo=Yes'):
# 			ret = Error(level=2,
#             			testclass=TestClass.FORMAT,
#             			)
# 			return [ret]

#   		if col_idx == utils.FEATS and cols[col_idx] == 'Typo=Yes':
# 			# TODO: move elsewhere
...
# validate_mwt_empty_vals = Test("mwt-nonempty-field", mwt_empty_vals)