                    ...
                    if b==0:
                        ...
                        if npart > 1:
                            if eid in open_discontinuous_mentions:
                                ...
                                warn('something is wrong; open discontinuous mentions = %s' % (str(open_discontinuous_mentions)), testclass, testlevel=testlevel, testid='xxx', nodelineno=sentence_line+iline)
